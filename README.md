...
| 模块 | 说明 |
|------|------|
| 采集 | 东财多栏目（财经/股市/要闻/国内/国际/焦点）+ 财联社电报 + 新浪财经滚动 |
| 映射 | 词典：半导体、AI、油价、降息… → 板块 + ETF + 东财 BK |
| 热度 | 近 N 小时命中加权；**相对上一窗口**；利空降权 / 去洗稿 |
| 盘面确认 | 对照东财行业/概念涨跌：共振 / 仅新闻 / 背离；动作提示 |
| Server酱 | **09:00** 盘前总报 · **13:00** 盘中总报 · 交易时段变化简报（有变化且≥30分钟）· **21:00** 晚间总报 |
| 导出 | `GET /api/export/sectors` 供牛来软接入（tone / action_hint / board_bk） |
| LLM | 预留开关，默认关闭 |
